                ...
                runOnUiThread(() -> {
                    try {
                        ...
                        if (jsonArray.length() > 0) {
                            ...
                            Toast.makeText(GameActivity.this, "Rhyme Word: " + RhythmWord, Toast.LENGTH_LONG).show();
                        } else {
                            Toast.makeText(GameActivity.this, "No rhyme found", Toast.LENGTH_SHORT).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                        Toast.makeText(GameActivity.this, "Error parsing response", Toast.LENGTH_SHORT).show();
                    }
                });
            }
